...
$sql1 ="SELECT * From logs iNNER JOIN information where  information.emp_id=logs.emp_id and logs.dt = '$date' and logs.time_out= '' Order By logs.dt DESC";
...
$sqll=mysql_query("SELECT SUM(salaryaday) as total FROM logs inner join information where information.emp_id=logs.emp_id ORDER BY logs.id DESC");
