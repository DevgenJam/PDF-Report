...
<h4>ACTIVITY LOG FOR LOG IN WITH LOG OUT
</h4>
  <hr>
 <input type="text" name="filter" value=""  id="filter" placeholder="Search here..." autocomplete="off" /><br>
...
$sql1 ="SELECT * From logs iNNER JOIN information where  information.emp_id=logs.emp_id and logs.tag='0' Order By logs.id DESC";
