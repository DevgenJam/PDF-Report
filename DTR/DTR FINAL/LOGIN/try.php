<?php 
mysql_connect("localhost","root","")or die("DATABASE IS OFFLINE");
mysql_select_db("cao1")or die("NO DATABASE FOUND");
...
//						echo '<script>alert("GOOD")</script>';
						$sql5=mysql_query("SELECT * FROM schedule where emp_id='$id' and day='$day_namenow'");
