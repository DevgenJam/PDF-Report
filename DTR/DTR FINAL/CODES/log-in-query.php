...
//					echo '<script>alert("YOU ARE ALREADY LOGGED IN")</script>';
					$sql4=mysql_query("SELECT * FROM logs where emp_id='$id' and dt='$date' and statuss='SPECIAL SHIFT' || statuss='DOUBE SHIFT'");
					if(mysql_num_rows($sql4)==0)
					{
						$sqll4=mysql_query("SELECT * FROM logs where emp_id='$id' and dt='$date'");
						if(mysql_num_rows($sqll4)==0)
						{
